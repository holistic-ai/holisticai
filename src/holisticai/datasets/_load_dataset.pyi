...
def load_dataset(
    ...
    preprocessed: bool = True): ... # type: ignore
...
def load_dataset(
    ...
    preprocessed: bool=True,
    protected_attribute: Union[Literal["race"], None]=None):... # type: ignore
@overload
def load_dataset(
...
def load_dataset(
    ...
    protected_attribute: Union[Literal["sex"], None] = None):... # type: ignore