...
def multiclass_xai_features(
    ...
    return compute_xai_features(
        dataset=dataset, learning_task_settings=learning_task_settings, feature_importance_fn=feature_importance_fn
    )


def multiclass_xai_metrics(
    X: NDArray,
    y: ArrayLike,
    predict_fn: callable,
