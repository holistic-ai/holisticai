...
class PyTorchRegressor(
    RegressorMixin, PyTorchEstimator
    ...
    def fit_generator(
        ...
        from holisticai.robustness.preprocessing.standardisation_mean_std.pytorch import (
    ...
    def clone_for_refitting(
        self,
    ) -> "PyTorchRegressor":  # lgtm [py/inheritance/incorrect-overridden-signature]
        """
        ...
        clone = type(self)(
            model, self._loss, self.input_shape, optimizer=self._optimizer
        )
        # reset weights
        clone.reset()
