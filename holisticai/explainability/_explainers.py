...
from holisticai.explainability.plots import bar, lolipop, contrast_matrix, partial_dependence_plot
...
from .metrics.feature_importance.global_importance._contrast_metrics import important_constrast_matrix
...
class Explainer:
    ...
    def contrast_visualization(self, show_connections=False):
        ...
        xticks , matrix =  important_constrast_matrix(cfimp, fimp, keys, show_connections=show_connections)
    ...
    def partial_dependence_plot(self, grid_resolution=20, top_k=0.8, ax=None):
        ...
        return partial_dependence_plot(x, features, title, model, grid_resolution=grid_resolution, ax=ax)
