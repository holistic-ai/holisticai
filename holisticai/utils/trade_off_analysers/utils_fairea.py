...
def get_closer_bounds(point, x_arr, y_arr, bound="lower"):
    ...
    x_arr : The array of the x axis.
    y_arr : The array of the y axis.
    bound : The bound to be compared if lower or upper.

    """
    if bound == "lower":
        bounds = (point > x_arr) * x_arr
    else:
        bounds = (point < x_arr) * x_arr
    if np.any(bounds) == 0:
        return None
    idx = np.argmin((bounds - point) ** 2)
...
def do_line_segments_intersect(segment1, segment2):
    ...
    q1 : The second point of the first line segment.
    p2 : The first point of the second line segment.
    q2 : The second point of the second line segment.
...
def get_baseline_bounds(point, fairness_axis, acc_axis):
    ...
    ----------
    point : The point to be compared.
    fairness_axis : The array of the fairness axis.
    acc_axis : The array of the accuracy axis.
...
def get_indexes(x_segment, y_segment, x_axis, y_axis):
    ...
    Parameters
    ----------
    x_segment : The segment of the fairness axis.
    y_segment : The segment of the accuracy axis.
    x_axis : The array of the fairness axis.
    y_axis : The array of the accuracy axis.
